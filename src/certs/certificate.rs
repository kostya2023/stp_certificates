...
use crate::{
    Error, Serilizaton, certs::tbs_certificate::TbsCertificate, highlevel_keys::AlgorithmIdentifier,
};
use yasna;
...
impl Certificate {
    pub fn new(
        ...
        Self {
            tbs_certificate,
            signature_algorithm,
            signature_value: signature_value.to_vec(),
        }
    }
...
// Serilizaton
impl Serilizaton for Certificate {
    fn to_der(&self) -> Vec<u8> {
        ...
        yasna::construct_der(|writer| {
            writer.write_sequence(|seq| {
                ...
                seq.next()
                    .write_bitvec_bytes(&self.signature_value, self.signature_value.len() * 8);
            })
        })
    }
